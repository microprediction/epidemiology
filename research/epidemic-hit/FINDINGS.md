...
## 2026-09-23: an independent measure of activity heterogeneity (analysis/15_polymod.py, 16_age_activity.py)
Research continues in the epidemiology repository (copied from homogenization/research/epidemic-hit).
POLYMOD contact diaries (Mossong et al. 2008; 7,290 participants, 8 countries): CV^2 of the number of contacts on the
diary day, within age bands, is 0.3-1.1 (pooled: 0-19 0.53, 20-64 0.63, 65+ 0.77; close contacts slightly higher).
Joint structure, no fitting: Prem et al. matrix across 16 age groups x gamma activity within band (POLYMOD CV^2),
activity scaling both susceptibility and infectivity, held fixed through the wave:

| country | lam | R 1.6: peak attack | rule 1 - R^(-1/lam) | final | textbook |
|---|---|---|---|---|---|
| USA | 2.70 | 0.185 | 0.160 | 0.330 | 0.375 |
| Sweden | 2.77 | 0.181 | 0.156 | 0.324 | 0.375 |
| Spain | 2.66 | 0.185 | 0.162 | 0.330 | 0.375 |
| UK | 3.02 | 0.173 | 0.144 | 0.311 | 0.375 |
| Brazil | 2.30 | 0.199 | 0.185 | 0.354 | 0.375 |

The fit-free lam of 2.3-3.0 matches the lam measured where control was weak: US county waves in winter 2020-21
(2-3.5 over IFR 0.5-1%) and Manaus (2.5). Held fixed, the same heterogeneity would cap Manaus' final attack near 35%;
the observed 66-76% says activity reshuffles after the first turnover (time-varying heterogeneity), which is the
switching picture: early depletion at the frozen lam, final size close to homogeneous.
Caveats: one-day diaries mix persistent and day-to-day variation, so the frozen lam is an upper bound for the
