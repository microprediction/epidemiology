...
$\lambda = 3.4$--$3.7$ when daily contacts are capped at 20 and 4.6--6.8 at caps of 50 and 100, without fitting to
epidemic outcomes. Winter 2020--21 US county waves imply about 3.5 when growth is estimated from deaths and the
infection fatality rate is 0.7\%, and 2.4--5.3 for rates from 0.5\% to 1\%.
\end{abstract}
...
near 2.5 and a threshold of 60\%. \citet{cotton2020fundamental} called the gap between such thresholds and the
observed peaks the herd-immunity paradox and argued that it follows from variation in transmission across people,
...
and showed that the resulting suppression is partly transient.
...
backs a value out of the peaks of US county waves under an assumed fatality rate. The two agree at about 3.5 for a
20-contact cap and a 0.7\% fatality rate, and both depend on those choices.
...
turnover, averaged over places, is $\mathbb{E}[\gamma/\beta] = J/\bar R$ with $J = \mathbb{E}[1/\eta] \ge 1$. Together,
\begin{equation}
...
5.9--6.8 at 100. We lead with the cap of 20 because it limits the influence of a few reports of very large groups.
That choice is not derived from transmission data, and how many of a very busy person's contacts can transmit is
unresolved.
...
control was weak, in Manaus and in the US county waves of winter 2020--21, $\hat\lambda$ is 2 to 3.5.
\citet{tkachenko2021} fit an immunity factor of about 4 to New York City and Chicago with a model that includes
mitigation.

\section{Discussion}

Contact surveys predict an immunity factor of 3.4--3.7 at a 20-contact cap and 4.6--6.8 at larger caps. Winter county
waves imply a peak index of 2.4--5.3 over fatality rates from 0.5\% to 1\%, 3.5 at 0.7\%, and about 2.1 with growth
from cases. The ranges overlap. At $R = 2.5$, $\lambda = 3.5$ puts the turnover near 23\%.
...
In the panel most of the resolved heterogeneity persists. The switching part is smaller and decorrelates over about a
month, so in this model a first-wave turnover is mostly a lasting reduction of the threshold with a transient on top.
